...
/* Module Version: 1.2 */
/* C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n efb_i2c_prgrm -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo3c00f -freq 66.5 -i2c1config -i2c1_freq 100 -i2c1_sa 1000001 -i2c1_addr 7 -ufm -ufm_ebr 2045 -mem_size 1 -ufm_0 -wb -dev 6900  */
/* Fri Oct 31 10:37:55 2025 */


`timescale 1 ns / 1 ps
module efb_i2c_prgrm (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
    ...
    defparam EFBInst_0.I2C1_CLK_DIVIDER = 167 ;
