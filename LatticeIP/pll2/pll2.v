...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n pll2 -lang verilog -synth synplify -arch xo3c00f -type pll -fin 133 -fclkop 99.75 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Thu Oct 30 15:36:03 2025 */


`timescale 1 ns / 1 ps
module pll2 (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
